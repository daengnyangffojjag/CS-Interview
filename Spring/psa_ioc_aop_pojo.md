...
Portable Service Abstraction의 줄임말로 환경과 세부 기술의 변화에 관계없이 일관된 방식으로 기술에 접근할 수 있게 해주는 것을 의미합니다. PSA가 적용된 대표적인 곳은 JDBC, JPA, Transaction Manager 등이 존재합니다.


> POJO란 무엇인가요?

Plain Old Java Object의 약어로, 평범한 구식 자바 객체를 의미합니다. 프레임워크 인터페이스나 클래스를 구현하거나 확장하지 않은 단순한 클래스를 의미하는 것으로, 타 프레임워크에 종속되지 않아 코드가 간결하고 테스트 자동화에 유리합니다. Spring에서는 도메인과 비즈니스 로직을 수행하는 대상이 POJO 대상이 될 수 있습니다.